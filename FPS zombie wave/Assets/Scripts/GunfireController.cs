...
namespace BigRookGames.Weapons
{
    public class GunfireController : MonoBehaviour
    {
        ...
        public float shotDelay = 0.1f; // Reduced shot delay for faster firing
        ...
        // --- Bullet Speed ---
        public float bulletVelocity = 30f; // Add this line to declare bulletVelocity
        ...
        private void Update()
        {
            ...
            // --- Manual firing ---
            if (Input.GetKeyDown(KeyCode.Mouse0) && ((timeLastFired + shotDelay) <= Time.time))
            {
                FireWeapon();
            }
        ...
        public void FireWeapon()
        {
            ...
            // --- Debug log muzzle position and rotation ---
            Debug.Log("Muzzle Position: " + muzzlePosition.transform.position);
            Debug.Log("Muzzle Rotation: " + muzzlePosition.transform.rotation);
            ...
            if (projectilePrefab != null)
            {
                ...
                if (rb != null)
                {
                    rb.AddForce(muzzlePosition.transform.forward * bulletVelocity, ForceMode.Impulse);
                }
                // Destroy the projectile after 4 seconds (adjust as needed)
                Destroy(newProjectile, 2f); // Change 4f to the desired time in seconds
            }
